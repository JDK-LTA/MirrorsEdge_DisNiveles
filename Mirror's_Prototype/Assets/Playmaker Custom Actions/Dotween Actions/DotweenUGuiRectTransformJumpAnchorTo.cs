...
namespace HutongGames.PlayMaker.Actions
{
		...
		[Tooltip("Tweens Jump the target's anchoredPosition in 2D")]
		[HelpUrl("http://dotween.demigiant.com/documentation.php")]
		public class DotweenUGuiRectTransformJumpAnchorTo : FsmStateAction
		{
			[ActionSection("Setup")]
			[RequiredField]
		...
		private string debugString = "<b>[DotweenUGuiRectTransformJumpAnchorTo]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
		...
		public override void Reset ()
		{
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenUGuiRectTransformJumpAnchorTo]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>",this.Owner);
				break;
			...
			_target.GetComponent<RectTransform>().DOJumpAnchorPos(Vector2setup,jumpPower.Value, jumpNumber.Value,duration.Value, snapping.Value).SetAs(setFinal);
