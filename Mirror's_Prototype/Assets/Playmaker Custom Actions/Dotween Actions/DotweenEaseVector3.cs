...
namespace HutongGames.PlayMaker.Actions
{
		...
		[Tooltip("Ease Vector3")]
		[HelpUrl("http://dotween.demigiant.com/documentation.php")]
	public class DotweenEaseVector3 : FsmStateAction
		{
		...
		private string debugString = "<b>[DotweenEaseVector3]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
			
		public override void Reset ()
		{
				toValue = new FsmVector3 { UseVariable = true };
				fromValue = new FsmVector3 { UseVariable = true };
				resultValue = new FsmVector3 { UseVariable = true };
				duration = 0f;
				setDelay = 0f;
				isSpeedBased = false;
				settingLoops = 0;
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenEaseVector3]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>",this.Owner);
				break;
			...
			case Constraint.AxisConstraintZ:
				axisSetup = AxisConstraint.Z;
				break;
