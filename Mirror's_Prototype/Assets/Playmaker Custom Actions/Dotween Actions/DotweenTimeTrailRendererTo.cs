...
namespace HutongGames.PlayMaker.Actions
{
		...
		public class DotweenTimeTrailRendererTo : FsmStateAction
		{
			[ActionSection("Setup")]
			[RequiredField]
		...
		private string debugString = "<b>[DotweenTimeTrailRendererTo]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
		...
		public override void Reset ()
		{
			...
			{
				Debug.LogWarning("<b>[DotweenTimeTrailRendererTo]</b><color=#FF9900ff>Missing TrailRenderer component </color>",this.Owner);
				return;
			}	
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenTimeTrailRendererTo]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>",this.Owner);
				break;
			...
			trailRenderer.DOTime(startWidth.Value, duration.Value).SetAs(setFinal);
