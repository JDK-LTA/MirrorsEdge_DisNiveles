...
namespace HutongGames.PlayMaker.Actions
{
		...
		[Tooltip("Tweens a Camera's pixelRect / rect")]
		[HelpUrl("http://dotween.demigiant.com/documentation.php")]
		public class DotweenCameraRectTo : FsmStateAction
		{
			[ActionSection("Setup")]
		...
		private string debugString = "<b>[DotweenCameraRectTo]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
		...
		public override void Reset ()
		{
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenCameraRectTo]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>\",this.Owner");
				break;
