...
namespace HutongGames.PlayMaker.Actions
{
		...
		public class DotweenEaseFloat : FsmStateAction
		{
		...
		private string debugString = "<b>[DotweenEaseFloat]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
		...
		public override void Reset ()
		{
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenEaseFloat]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>",this.Owner);
				break;
