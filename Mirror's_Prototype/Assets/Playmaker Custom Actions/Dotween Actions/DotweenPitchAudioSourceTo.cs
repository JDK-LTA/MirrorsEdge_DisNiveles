...
namespace HutongGames.PlayMaker.Actions
{
		...
		[Tooltip("Pitch using the Audio Source from the target's current position to the given value. ")]
		[HelpUrl("http://dotween.demigiant.com/documentation.php")]
		public class DotweenPitchAudioSourceTo : FsmStateAction
		{
			[ActionSection("Setup")]
			...
			[ActionSection("Pitch Setup")]
			[UIHint(UIHint.FsmFloat)]
			public FsmFloat PitchTo;
		...
		private string debugString = "<b>[DotweenPitchAudioSourceTo]</b><color=#E9E581ff> ...mmm did 'DoTween' work ?? </color>";
		...
		public override void Reset ()
		{
			...
			case loopType.None:
				if (settingLoops > 0 || settingLoops < 0) Debug.LogWarning ("<b>[DotweenPitchAudioSourceTo]</b><color=#FF9900ff>!!! Loop Time is set but no 'Loop Type' is selected !!! </color>",this.Owner);
				break;
			...
			// Easy part to edit for other DotTween actions --->
				...
				_target.GetComponent<AudioSource>().DOFade(PitchTo.Value, duration.Value).SetAs(setFinal);
